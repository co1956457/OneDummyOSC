...
namespace OneDummy
{
    public partial class ComNiCmnt : Form
    {
        public ComNiCmnt()
        {
            InitializeComponent();
        ...
        private void buttonNiconamaCommentOSC_Click(object sender, EventArgs e)
        {
            ...
            string jsonString = CommonNiconamaCommentSerialize();

            // デバッグ for debugging purposes
            // string path = @"C:\example\";
            // File.WriteAllText(path + "commonNiconamaComment.txt", jsonString);
        ...
        private string CommonNiconamaCommentSerialize()
        {
            // テキスト情報を読み取り JSON 化
